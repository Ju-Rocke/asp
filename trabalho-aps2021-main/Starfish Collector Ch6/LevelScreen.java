...
public class LevelScreen extends BaseScreen
{
    ...
    {        
        ...
        new Starfish(300,350, mainStage);
        ...
        sign1.setText("Socorro!!! Salve nosso lar");

        Sign sign2 = new Sign(600,300, mainStage);
        sign2.setText("Pegue todas as garrafas pets para passar de Nivel");
        ...
        starfishLabel = new Label("Reciclado:", BaseGame.labelStyle);
    ...
    public void update(float dt)
    {
        ...
        starfishLabel.setText("Reciclado: " + BaseActor.count(mainStage, "Starfish"));
